...
obliku deset cifara (mogu biti nule na poèetku), koji je unikatan za svaki artikal, ime, kao i cijenu
...
ime samo ispisati upozorenje i pitati korisnika da li je siguran da æe to uraditi.
Sve moguæe smetnje je potrebno otkloniti, poput onih koje nastaju kada se pogrešna informacija upiše,
npr. code ima slova ili nema deset cifara.
TASK #3 – BRISANJE ARTIKALA
Napraviti GUI aplikaciju, baziranu na prethodnoj, koja briše jedan od ponuðenih artikala. Artikal se
