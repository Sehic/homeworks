...
public class MainActivity extends AppCompatActivity {
    ...
    private static PersonList persons = PersonList.get();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.length() < 2 || surname.length() < 2) {
                    ...
                    PersonList.get().addPerson(person);
        ...
        sortByName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Collections.sort(PersonList.get().getPersons(), new Comparator<PersonModel>() {
                    @Override
    ...
    private class PersonHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public PersonHolder(View personView) {
            ...
            removePersonButton.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    PersonList.get().removePerson(mPerson);
                    updateUI();
                }
            });
        }
        ...
        public void onClick(View v) {
            ...
            bundle.putSerializable(KEY_INTENT, "Person");
        ...
        public void bindPerson(PersonModel person) {
            ...
            firstNameView.setText(person.getName());
            lastNameView.setText(person.getSurname());
            dateView.setText(person.getDateAdded().toString());
        }
    }
    ...
    private class PersonAdapter extends RecyclerView.Adapter<PersonHolder> {
        ...
        public void onBindViewHolder(PersonHolder holder, int position) {
            PersonModel person = PersonList.get().getPersons().get(position);
            holder.bindPerson(person);
        }

        @Override
        public int getItemCount() {
            return PersonList.get().getPersons().size();
        }
